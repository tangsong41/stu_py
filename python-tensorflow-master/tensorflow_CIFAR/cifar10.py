...
# 描述训练京城的常量
MOVING_AVERAGE_DECAY = 0.9999  # The decay to use for the moving average. # 用于表示滑动平均的衰减量
NUM_EPOCHS_PER_DECAY = 350.0  # Epochs after which learning rate decays.  # 学习率衰减之后的周期
